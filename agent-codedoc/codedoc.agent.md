...
4. **Phase 2 — Analyze:** Use the collected facts to reason about each architecture area. Be thorough but only document what's **actually in the code**. Do NOT invent components.
